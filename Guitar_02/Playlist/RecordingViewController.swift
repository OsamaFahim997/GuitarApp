...
extension RecordingViewController : UITableViewDelegate , UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(String(name[name.count - 1]))
    ...
    func saveData(){
        let alert = UIAlertController(title: "Confirm", message: "Add this song to playlist?", preferredStyle: UIAlertController.Style.alert)
